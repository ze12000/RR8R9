...
def stream_markup_timer(_, chat_id, played, dur):
    buttons = [
        ...
        [ 
            InlineKeyboardButton(text="ᖇ꧖ρᥣꪖꪗ", callback_data=f"ADMIN Replay|{chat_id}"),
            InlineKeyboardButton(text="᥉ƙᎥρ", callback_data=f"ADMIN Skip|{chat_id}"),
        ],
        [
            InlineKeyboardButton(text="‹ 𝙀𝙉𝘿 ›", callback_data=f"ADMIN Stop|{chat_id}")
        ],
        [
            InlineKeyboardButton(
                text="「 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙑𝘼𝙏𝘼𝙍 」", url=SUPPORT_CHAT,
